...
<script type="module">
    ...
    const questions = [
        ...
        "How many clouds are in the sky right now?",
        "Do birds judge us for walking instead of flying?",
        "If Earth is round, why don’t we roll off?",
        "How long does a moment last?",
        "Can you get sunburned by moonlight?",
        ...
        "Why do aliens only abduct lonely people?",
        "When did god die?",
        ...
        "Are ghosts transparent because they have nothing to hide?",
        "Do magnets ever get lonely?",
        "How do you politely ask your shadow for privacy?",
        "Are marshmallows just confused clouds?",
        "Are there vegan vampires?",
        "What are chairs thinking when we sit on them?",
        "Why do ducks never wear pants?",
        "Do islands float or swim?",
        "Are yawns contagious to plants?",
        "How much memory does forgetting save?",
