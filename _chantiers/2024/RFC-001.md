...
description: |
    <p><b>Idea:</b> The project started as an exploration on how to create context for an LLM to build robust apps.<br>It later proved to be possible to generate code that was so robust, it could even solve improbable problems.</p>
...
(function() {
    ...
    /* --- Initial State --- */
    /* Only focus on screens larger than 900px to avoid mobile keyboard issues */
