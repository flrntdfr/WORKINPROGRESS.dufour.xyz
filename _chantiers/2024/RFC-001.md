...
description: |
    <p><b>Idea:</b> The project started as an exploration to generate robust code with an LLM.<br>It later proved to be possible to generate code that was so robust, it could even solve improbable problems.</p>
