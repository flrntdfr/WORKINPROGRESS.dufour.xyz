...
description: |
    With this project, I wanted to find a way to get functional code to an improbable problem using a Large Language Model (LLM).
    <br>
    The strategy consists in prompting the LLM to generate a Request For Comments (RFC) before implementing C code.
    <br>
    The LLM was able to express a complex task with regards to the  Human-centric Title Case project in less than 2300 words and fit the algorithm within 2 pages (131072 bytes) of C code. It finally got it to run instantly in the browser through an interactive demo using WebAssembly.
    <br><br>
    <b>Exercise:</b>
    <br>
