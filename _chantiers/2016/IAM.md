...
const lists = {
  en: {
    ...
    listB: [
      ...
      "I fear change.",
      "I can make a compelling case against humanity.",
  ...
  fr: {
    ...
    listB: [
      ...
      "j'accepterais de rédiger le résumé de l'humanité.",
      ...
      "je suis une blonde sous cocaïne qui va vomir.",
